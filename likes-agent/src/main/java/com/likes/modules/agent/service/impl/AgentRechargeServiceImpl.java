...
import com.likes.common.model.response.AgentRechargeOrder;
 ...
 */
@Service
public class AgentRechargeServiceImpl extends BaseServiceImpl implements AgentRechargeService {
    ...
    @Override
    public PageResult rechargeList(AgentOrderReq req, PageBounds page) {
        ...
        Page<AgentRechargeOrder>  list = traOrderinfomMapperService.agentRechargeOrderList(req, page.toRowBounds());
