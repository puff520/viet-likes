...
public class AgPayTypeExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AgPayTypeExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ag_pay_type
     *
     * @mbggenerated
     */
