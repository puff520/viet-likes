...
public class BjpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public BjpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table bjpks_count_sgds
     *
     * @mbggenerated
     */
