...
public class JsbjpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsbjpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public JsbjpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsbjpks_lottery_sg
     *
     * @mbggenerated
     */
