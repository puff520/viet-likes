...
public class JsbjpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsbjpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public JsbjpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsbjpks_count_sgds
     *
     * @mbggenerated
     */
