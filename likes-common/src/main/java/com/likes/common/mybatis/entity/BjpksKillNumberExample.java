...
public class BjpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public BjpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table bjpks_kill_number
     *
     * @mbggenerated
     */
