...
public class TenbjpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenbjpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public TenbjpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenbjpks_count_sglh
     *
     * @mbggenerated
     */
