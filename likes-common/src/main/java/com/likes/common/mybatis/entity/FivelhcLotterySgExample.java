...
public class FivelhcLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivelhcLotterySgExample() {
     ...
     * @mbggenerated
     */
    public FivelhcLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivelhc_lottery_sg
     *
     * @mbggenerated
     */
