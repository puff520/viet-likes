...
public class AeGameExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AeGameExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ae_game
     *
     * @mbggenerated
     */
