...
public class LotteryPreAwardExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LotteryPreAwardExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table lottery_pre_award
     *
     * @mbggenerated
     */
