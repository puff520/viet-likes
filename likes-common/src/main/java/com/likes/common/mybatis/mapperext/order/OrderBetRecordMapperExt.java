...
import com.likes.common.model.dto.order.OrderBetRecordCalcDTO;
import com.likes.common.model.dto.order.OrderBetRecordResultDTO;
import com.likes.common.model.dto.report.LotDailyWinDataDO;
import com.likes.common.model.dto.report.LotteryBetDataDO;
import com.likes.common.model.dto.report.LotteryDataDO;
import com.likes.common.model.vo.order.OrderBetVo;
...
//    HashMap<String, Object> selectVaildMoneyByIssue(@Param("playids") List<Integer> playids, @Param("status") String status, @Param("startTime") String startTime, @Param("endTime") String endTime, @Param("userId") Integer userId, @Param("issue") String issue, @Param("orderCode") String orderCode, @Param("lotteries") List<Integer> lotteries);
    ...
    LotDailyWinDataDO statisticalDayData(@Param("startTime") String startTime, @Param("endTime") String endTime);

    LotDailyWinDataDO statisticalDayWinData(@Param("startTime") String startTime, @Param("endTime") String endTime);


    List<LotteryBetDataDO> statisticalAllBetData(@Param("startTime") String startTime, @Param("endTime") String endTime);

    List<LotteryDataDO> statisticalDataBylottery(@Param("startTime") String startTime, @Param("endTime") String endTime);
