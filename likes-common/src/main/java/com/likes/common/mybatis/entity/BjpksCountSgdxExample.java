...
public class BjpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public BjpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table bjpks_count_sgdx
     *
     * @mbggenerated
     */
