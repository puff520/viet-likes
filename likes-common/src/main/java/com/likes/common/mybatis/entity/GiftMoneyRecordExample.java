...
public class GiftMoneyRecordExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public GiftMoneyRecordExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table gift_money_record
     *
     * @mbggenerated
     */
