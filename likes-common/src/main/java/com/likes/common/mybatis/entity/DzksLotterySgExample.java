...
public class DzksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public DzksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table dzks_lottery_sg
     *
     * @mbggenerated
     */
