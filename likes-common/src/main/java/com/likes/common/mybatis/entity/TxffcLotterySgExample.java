...
public class TxffcLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TxffcLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table txffc_lottery_sg
     *
     * @mbggenerated
     */
