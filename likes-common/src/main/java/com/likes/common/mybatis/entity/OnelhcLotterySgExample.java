...
public class OnelhcLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public OnelhcLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table onelhc_lottery_sg
     *
     * @mbggenerated
     */
