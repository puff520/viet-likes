...
public class MemFollowExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public MemFollowExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table mem_follow
     *
     * @mbggenerated
     */
