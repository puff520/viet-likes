...
public class DzxyftLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public DzxyftLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table dzxyft_lottery_sg
     *
     * @mbggenerated
     */
