...
public class JsbjpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsbjpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public JsbjpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsbjpks_count_sglh
     *
     * @mbggenerated
     */
