...
public class Fc3dLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public Fc3dLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fc3d_lottery_sg
     *
     * @mbggenerated
     */
