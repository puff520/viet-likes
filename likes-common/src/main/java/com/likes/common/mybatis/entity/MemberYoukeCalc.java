...
public class MemberYoukeCalc implements Serializable {
    /**
     * 字段: member_youke_calc.id<br/>
     * 主键: 自动增长<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
    ...
    /**
     * 字段: member_youke_calc.total_count<br/>
     * 必填: true<br/>
     * 缺省: 0<br/>
     * 长度: 10<br/>
     * 说明: 总人数
    ...
    /**
     * 字段: member_youke_calc.android_count<br/>
     * 必填: true<br/>
     * 缺省: 0<br/>
     * 长度: 10<br/>
     * 说明: 安卓在线人数
    ...
    /**
     * 字段: member_youke_calc.ios_count<br/>
     * 必填: true<br/>
     * 缺省: 0<br/>
     * 长度: 10<br/>
     * 说明: ios人数
    ...
    /**
     * 字段: member_youke_calc.h5_count<br/>
     * 必填: true<br/>
     * 缺省: 0<br/>
     * 长度: 10<br/>
     * 说明: h5人数
    ...
    /**
     * 字段: member_youke_calc.web_count<br/>
     * 必填: true<br/>
     * 缺省: 0<br/>
     * 长度: 10<br/>
     * 说明: pc人数
    ...
    /**
     * 字段: member_youke_calc.create_time<br/>
     * 必填: true<br/>
    ...
    /**
     * 字段: member_youke_calc.update_time<br/>
     * 必填: true<br/>
     * 缺省: CURRENT_TIMESTAMP<br/>
     * 长度: 19<br/>
     * 说明: 更新时间
    ...
    /**
     * @return member_youke_calc.total_count: 总人数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return member_youke_calc.android_count: 安卓在线人数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return member_youke_calc.ios_count: ios人数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return member_youke_calc.h5_count: h5人数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return member_youke_calc.web_count: pc人数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return member_youke_calc.create_time: 创建时间
     *
     * @mbggenerated
     */
    ...
    /**
     * @return member_youke_calc.update_time: 更新时间
     *
     * @mbggenerated
     */
    ...
    public boolean equals(Object that) {
        ...
        MemberYoukeCalc other = (MemberYoukeCalc) that;
