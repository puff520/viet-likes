...
public class XyftLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public XyftLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table xyft_lottery_sg
     *
     * @mbggenerated
     */
