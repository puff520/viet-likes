...
public class PceggLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public PceggLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table pcegg_lottery_sg
     *
     * @mbggenerated
     */
