...
public class AmlhcLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AmlhcLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table amlhc_lottery_sg
     *
     * @mbggenerated
     */
