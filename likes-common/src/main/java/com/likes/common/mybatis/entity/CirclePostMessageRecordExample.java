...
public class CirclePostMessageRecordExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public CirclePostMessageRecordExample() {
     ...
     * @mbggenerated
     */
    public CirclePostMessageRecordExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table circle_post_message_record
     *
     * @mbggenerated
     */
