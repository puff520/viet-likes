...
public class CirclePostReportTypeExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public CirclePostReportTypeExample() {
     ...
     * @mbggenerated
     */
    public CirclePostReportTypeExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table circle_post_report_type
     *
     * @mbggenerated
     */
