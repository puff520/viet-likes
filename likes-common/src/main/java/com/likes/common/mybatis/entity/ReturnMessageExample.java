...
public class ReturnMessageExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public ReturnMessageExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table return_message
     *
     * @mbggenerated
     */
