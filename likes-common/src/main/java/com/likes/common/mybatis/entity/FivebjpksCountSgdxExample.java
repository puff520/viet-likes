...
public class FivebjpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivebjpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public FivebjpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivebjpks_count_sgdx
     *
     * @mbggenerated
     */
