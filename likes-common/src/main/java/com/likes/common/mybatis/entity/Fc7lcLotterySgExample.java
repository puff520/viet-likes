...
public class Fc7lcLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public Fc7lcLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fc7lc_lottery_sg
     *
     * @mbggenerated
     */
