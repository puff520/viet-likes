...
public class CirclePostShieldExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public CirclePostShieldExample() {
     ...
     * @mbggenerated
     */
    public CirclePostShieldExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table circle_post_shield
     *
     * @mbggenerated
     */
