...
public class AuspksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AuspksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table auspks_lottery_sg
     *
     * @mbggenerated
     */
