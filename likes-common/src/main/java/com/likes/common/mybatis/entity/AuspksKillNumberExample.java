...
public class AuspksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AuspksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public AuspksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table auspks_kill_number
     *
     * @mbggenerated
     */
