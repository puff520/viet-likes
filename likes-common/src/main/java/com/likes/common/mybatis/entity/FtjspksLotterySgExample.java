...
public class FtjspksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FtjspksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public FtjspksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ftjspks_lottery_sg
     *
     * @mbggenerated
     */
