...
public class BjpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public BjpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table bjpks_count_sglh
     *
     * @mbggenerated
     */
