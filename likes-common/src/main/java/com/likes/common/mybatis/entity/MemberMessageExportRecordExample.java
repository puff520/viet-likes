...
public class MemberMessageExportRecordExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public MemberMessageExportRecordExample() {
     ...
     * @mbggenerated
     */
    public MemberMessageExportRecordExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table member_message_export_record
     *
     * @mbggenerated
     */
