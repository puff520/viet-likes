...
public class LhcLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LhcLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table lhc_lottery_sg
     *
     * @mbggenerated
     */
