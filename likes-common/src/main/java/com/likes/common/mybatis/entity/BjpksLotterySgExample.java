...
public class BjpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public BjpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table bjpks_lottery_sg
     *
     * @mbggenerated
     */
