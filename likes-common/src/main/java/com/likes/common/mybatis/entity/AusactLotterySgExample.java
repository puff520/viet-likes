...
public class AusactLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AusactLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ausact_lottery_sg
     *
     * @mbggenerated
     */
