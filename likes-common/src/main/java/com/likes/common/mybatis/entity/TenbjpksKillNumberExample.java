...
public class TenbjpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenbjpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public TenbjpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenbjpks_kill_number
     *
     * @mbggenerated
     */
