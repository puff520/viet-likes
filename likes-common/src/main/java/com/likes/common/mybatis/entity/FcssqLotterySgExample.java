...
public class FcssqLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FcssqLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fcssq_lottery_sg
     *
     * @mbggenerated
     */
