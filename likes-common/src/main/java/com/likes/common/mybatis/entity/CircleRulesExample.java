...
public class CircleRulesExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public CircleRulesExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table circle_rules
     *
     * @mbggenerated
     */
