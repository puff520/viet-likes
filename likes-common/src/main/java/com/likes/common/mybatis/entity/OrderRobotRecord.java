...
public class OrderRobotRecord implements Serializable {
    /**
     * 字段: order_robot_record.id<br/>
     * 主键: 自动增长<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
    ...
    /**
     * 字段: order_robot_record.user_id<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 用户id
    ...
    /**
     * 字段: order_robot_record.order_id<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 投注单id
    ...
    /**
     * 字段: order_robot_record.cate_id<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 彩种类别id
    ...
    /**
     * 字段: order_robot_record.lottery_id<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 彩种id
    ...
    /**
     * 字段: order_robot_record.play_id<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 玩法id
    ...
    /**
     * 字段: order_robot_record.setting_id<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 玩法配置id
    ...
    /**
     * 字段: order_robot_record.play_name<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 255<br/>
     * 说明: 玩法名称
    ...
    /**
     * 字段: order_robot_record.issue<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 50<br/>
     * 说明: 购买的期号
    ...
    /**
     * 字段: order_robot_record.order_sn<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 100<br/>
     * 说明: 订单号
    ...
    /**
     * 字段: order_robot_record.bet_number<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 255<br/>
     * 说明: 投注号码
    ...
    /**
     * 字段: order_robot_record.bet_count<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 投注总注数
    ...
    /**
     * 字段: order_robot_record.bet_amount<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 20<br/>
     * 说明: 投注金额
    ...
    /**
     * 字段: order_robot_record.win_amount<br/>
     * 必填: true<br/>
     * 缺省: 0.00<br/>
     * 长度: 20<br/>
     * 说明: 中奖金额
    ...
    /**
     * 字段: order_robot_record.back_amount<br/>
     * 必填: true<br/>
     * 缺省: 0.00<br/>
     * 长度: 20<br/>
     * 说明: 返点金额
    ...
    /**
     * 字段: order_robot_record.is_roboter<br/>
     * 必填: true<br/>
     * 缺省: 0<br/>
     * 长度: 10<br/>
     * 说明: 是否机器人注单, 0是 1否
    ...
    /**
     * 字段: order_robot_record.tb_status<br/>
     * 必填: true<br/>
     * 缺省: WAIT<br/>
     * 长度: 50<br/>
    ...
    /**
     * 字段: order_robot_record.is_delete<br/>
     * 必填: true<br/>
     * 缺省: b'0'<br/>
     * 长度: 1<br/>
     * 说明: 是否删除
    ...
    /**
     * 字段: order_robot_record.win_count<br/>
     * 必填: false<br/>
     * 缺省: 0<br/>
     * 长度: 50<br/>
     * 说明: 中奖注数
    ...
    /**
     * 字段: order_robot_record.is_push<br/>
     * 必填: false<br/>
     * 缺省: 0<br/>
     * 长度: 10<br/>
     * 说明: 是否推单 0 否 1 是
    ...
    /**
     * 字段: order_robot_record.create_time<br/>
     * 必填: true<br/>
    ...
    /**
     * 字段: order_robot_record.update_time<br/>
     * 必填: true<br/>
     * 缺省: CURRENT_TIMESTAMP<br/>
     * 长度: 19<br/>
     * 说明: 更新时间
    ...
    /**
     * 字段: order_robot_record.source<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 50<br/>
    ...
    /**
     * 字段: order_robot_record.familyid<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 19<br/>
     * 说明: 直播间购彩对应的家族id
    ...
    /**
     * 字段: order_robot_record.room_id<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 19<br/>
     * 说明: 直播房间id
     ...
     * This field corresponds to the database table order_robot_record
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.user_id: 用户id
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.order_id: 投注单id
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.cate_id: 彩种类别id
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.lottery_id: 彩种id
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.play_id: 玩法id
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.setting_id: 玩法配置id
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.play_name: 玩法名称
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.issue: 购买的期号
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.order_sn: 订单号
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.bet_number: 投注号码
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.bet_count: 投注总注数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.bet_amount: 投注金额
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.win_amount: 中奖金额
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.back_amount: 返点金额
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.is_roboter: 是否机器人注单, 0是 1否
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.tb_status: 状态：中奖:WIN | 未中奖:NO_WIN | 等待开奖:WAIT | 和:HE | 撤单:BACK
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.is_delete: 是否删除
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.win_count: 中奖注数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.is_push: 是否推单 0 否 1 是
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.create_time: 创建时间
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.update_time: 更新时间
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.source: 来源：Android | IOS | WEB
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.familyid: 直播间购彩对应的家族id
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_robot_record.room_id: 直播房间id
     *
     * @mbggenerated
     */
    ...
    public boolean equals(Object that) {
        ...
        OrderRobotRecord other = (OrderRobotRecord) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIsRoboter() == null ? other.getIsRoboter() == null : this.getIsRoboter().equals(other.getIsRoboter()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIsRoboter() == null) ? 0 : getIsRoboter().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", isRoboter=").append(isRoboter);
