...
public class AgGameExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AgGameExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ag_game
     *
     * @mbggenerated
     */
