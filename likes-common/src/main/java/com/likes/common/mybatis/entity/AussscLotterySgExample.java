...
public class AussscLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AussscLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ausssc_lottery_sg
     *
     * @mbggenerated
     */
