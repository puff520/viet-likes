...
public class OrderBetRecord implements Serializable {
    ...
    /**
     * 字段: order_bet_record.trial_id<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 试玩房间
    ...
    /**
     * @return order_bet_record.type: 0:普通订单 1:试玩订单
     *
     * @mbggenerated
     */
    ...
    /**
     * @return order_bet_record.trial_id: 试玩房间
     *
     * @mbggenerated
     */
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTrialId() == null ? other.getTrialId() == null : this.getTrialId().equals(other.getTrialId()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTrialId() == null) ? 0 : getTrialId().hashCode());
        return result;
    }
