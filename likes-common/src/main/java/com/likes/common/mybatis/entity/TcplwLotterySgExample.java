...
public class TcplwLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TcplwLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tcplw_lottery_sg
     *
     * @mbggenerated
     */
