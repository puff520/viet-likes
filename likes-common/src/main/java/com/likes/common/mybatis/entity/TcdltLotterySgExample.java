...
public class TcdltLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TcdltLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tcdlt_lottery_sg
     *
     * @mbggenerated
     */
