...
public class FivebjpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivebjpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public FivebjpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivebjpks_kill_number
     *
     * @mbggenerated
     */
