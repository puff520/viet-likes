...
public class TenbjpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenbjpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public TenbjpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenbjpks_count_sgds
     *
     * @mbggenerated
     */
