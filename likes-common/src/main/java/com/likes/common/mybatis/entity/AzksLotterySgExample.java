...
public class AzksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AzksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table azks_lottery_sg
     *
     * @mbggenerated
     */
