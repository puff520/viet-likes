...
public class MemberInstationMessageExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public MemberInstationMessageExample() {
     ...
     * @mbggenerated
     */
    public MemberInstationMessageExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table member_instation_message
     *
     * @mbggenerated
     */
