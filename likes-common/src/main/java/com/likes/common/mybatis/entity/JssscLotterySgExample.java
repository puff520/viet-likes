...
public class JssscLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JssscLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsssc_lottery_sg
     *
     * @mbggenerated
     */
