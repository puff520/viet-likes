...
public class FivebjpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivebjpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public FivebjpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivebjpks_count_sgds
     *
     * @mbggenerated
     */
