...
public class TenbjpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenbjpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public TenbjpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenbjpks_lottery_sg
     *
     * @mbggenerated
     */
