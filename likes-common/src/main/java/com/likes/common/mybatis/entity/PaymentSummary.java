...
public class PaymentSummary implements Serializable {
    ...
    /**
     * @return payment_summary.status: 支付状态：1成功2失败3等待支付(审核)
     *
     * @mbggenerated
     */
    ...
    /**
     * @return payment_summary.quick: 附言
     *
     * @mbggenerated
     */
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getQuick() == null ? other.getQuick() == null : this.getQuick().equals(other.getQuick()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getQuick() == null) ? 0 : getQuick().hashCode());
        return result;
    }
