...
public class GameBetamountRecordExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public GameBetamountRecordExample() {
     ...
     * @mbggenerated
     */
    public GameBetamountRecordExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table game_betamount_record
     *
     * @mbggenerated
     */
