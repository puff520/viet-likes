...
public class GodPlanLotteryCategoryExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public GodPlanLotteryCategoryExample() {
     ...
     * @mbggenerated
     */
    public GodPlanLotteryCategoryExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table god_plan_lottery_category
     *
     * @mbggenerated
     */
