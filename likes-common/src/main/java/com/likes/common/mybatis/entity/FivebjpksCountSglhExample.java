...
public class FivebjpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivebjpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public FivebjpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivebjpks_count_sglh
     *
     * @mbggenerated
     */
