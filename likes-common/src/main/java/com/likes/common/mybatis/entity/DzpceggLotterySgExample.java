...
public class DzpceggLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public DzpceggLotterySgExample() {
     ...
     * @mbggenerated
     */
    public DzpceggLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table dzpcegg_lottery_sg
     *
     * @mbggenerated
     */
