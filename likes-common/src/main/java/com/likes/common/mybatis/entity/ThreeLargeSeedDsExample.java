...
public class ThreeLargeSeedDsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public ThreeLargeSeedDsExample() {
     ...
     * @mbggenerated
     */
    public ThreeLargeSeedDsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table three_large_seed_ds
     *
     * @mbggenerated
     */
