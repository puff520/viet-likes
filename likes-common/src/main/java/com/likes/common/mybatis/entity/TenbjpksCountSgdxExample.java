...
public class TenbjpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenbjpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public TenbjpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenbjpks_count_sgdx
     *
     * @mbggenerated
     */
