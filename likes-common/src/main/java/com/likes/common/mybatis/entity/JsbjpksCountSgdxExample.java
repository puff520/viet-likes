...
public class JsbjpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsbjpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public JsbjpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsbjpks_count_sgdx
     *
     * @mbggenerated
     */
