...
public class ReturnWaterSetExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public ReturnWaterSetExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table return_water_set
     *
     * @mbggenerated
     */
