...
public enum SystemTipEnum {
	...
	OPETION_NODATA("100007", "已经没有数据操作了"),
	OPETION_NODATA_EN("110007", "No data for opetion"),
	...
	VOTE_FAILED_EN("110003", "Sorry, your voted failed"),

	OVER_LIMIT("100004", "对不起，你的投票次数超过限制啦"),
	OVER_LIMIT_EN("110004", "Sorry, you are over the limit"),

	VOTE_CHOICED_FAILED("100005", "亲，你的投票内容不正确"),
	VOTE_CHOICED_FAILED_EN("110005", "Sorry, your voted incorrectly"),
