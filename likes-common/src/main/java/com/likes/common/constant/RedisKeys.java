...
public class RedisKeys {
    ...
    public static final String UPDATE_YUEBAO_BALANCE_ = "UPDATE_YUEBAO_BALANCE_";
    ...
    public static final String LOTTERY_HOT_LIST = "LOTTERY_HOT_LIST";
    public static final String LOTTERY_HOT_SORT_HASH = "LOTTERY_HOT_SORT_HASH";
    public static final String LOTTERY_HOT_SORT_LIST = "LOTTERY_HOT_SORT_LIST";
    ...
    public static final String WEBAGENTONLINE = "LIVE_WEBAGENTONLINE";
     ...
     * 机器人信息前缀
     */
    public static final String LIVE_ROBOT = "LIVE_ROBOT";
    /**
     * 敏感词
     */
    public static final String LIVE_SYS_SENSITIVE_WORLD = "LIVE_SYS_SENSITIVE_WORLD";

    /**
     * 中奖机器人信息
     */
    public static final String LIVE_ROBOTKEYLIST = "LIVE_SETROBOTKEYLIST";

    /**
     * 非中奖机器人信息
     */
    public static final String LIVE_ROBOTKEYLISTSTR = "LIVE_SETROBOTKEYLISTSTR";

    public static final String LIVE_ROBOTBEFOREROBOTNUMS = "LIVE_ROBOTBEFOREROBOTNUMS";

    public static final String LIVE_ROBOTNOWROBOTNUMS = "LIVE_ROBOTNOWROBOTNUMS";
    /**
     * 机器人房间
     */
    public static final String LIVE_WAITROOM = "WAITROOM_";

    /**
     * 机器人礼物
     */
    public static final String LIVE_LIWU = "LIWU_";
    /**
     * 机器人房间
     */
    public static final String LIVE_CAIPIAO = "CAIPIAO_";


    /**
     * 机器人注单主表信息key
     */
    public static final String LIVE_ROBOT_ORDER_RECORD = "ROBOT_ORDER_RECORD";

    /**
     * 机器人注单副表信息key
     */
    public static final String LIVE_ROBOT_ORDER_ROBOT_RECORD = "ROBOT_ORDER_ROBOT_RECORD";
    /**
     * 机器人key
     */
    public static final String LIVE_ROBOTER = "ROBOTER";

    //会员等级配置所有等级排序
    public static final String MEM_LEVEL_CONFIG_ALL = "LIVE_MEM_LEVEL_CONFIG_ALL";

    public static final String MEM_LEVEL_LIST = "MEM_LEVEL_LIST";

    public  static  final String WEB_NOTE_INFO = "WEB_NOTE_INFO";
}
