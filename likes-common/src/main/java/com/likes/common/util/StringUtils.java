...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * 正则表达式：验证手机号
     */
//    private static final String REGEX_MOBILE = "^((13[0-9])|(15[^4,\\D])|(14[57])|(17[0-9])|(18[0-9]))\\d{8}$";
    private static final String REGEX_MOBILE = "\\d{11}";
    /**
     * 正则表达式：验证试玩账号123开头的
     */
//    private static final String REGEX_MOBILE = "^((13[0-9])|(15[^4,\\D])|(14[57])|(17[0-9])|(18[0-9]))\\d{8}$";
    private static final String TRIAL_MOBILE = "^123\\d*";
    ...
    public static String splitAndRandom(String source) {
        if (org.apache.commons.lang3.StringUtils.isNotEmpty(source)) {
            String[] tempArray = source.split(",");
            String temp = tempArray[((int) (Math.random() * 10000000D)) % tempArray.length];
    ...
    public static List<Integer> splitIntList(String str, String separate) {
        if (isEmpty(str)) {
    ...
    public static List<Long> splitLongList(String str, String separate) {
        if (isEmpty(str)) {
            return null;
        }
        String[] arr = str.split(separate);
    ...
    public static boolean isValid(String tel) {
        ...
        return Pattern.matches(TRIAL_MOBILE, tel);
    }
