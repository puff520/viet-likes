...
//	}
    ...
    public static String format(long period) {
        ...
        long hourUnit = 3600L;
        long minUnit = 60L;
        String result = MessageFormat.format(DEFAULT_PERIOD_FORMAT, Long.valueOf(period / dayUnit), Long.valueOf(period % dayUnit / hourUnit), Long.valueOf(period % hourUnit / minUnit));
        return result;
    }
...
//        return day +"天"+ hour +"小时" + min +"分钟";
    ...
    public static List<String> monthDays(String date) {
