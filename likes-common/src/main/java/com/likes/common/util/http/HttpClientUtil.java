...
import com.likes.common.util.RandUtil;
...
public class HttpClientUtil extends HttpCommonUtils {
    ...
    public static String formPostWithSign(String url, String methodname, Map<String, String> params) {
        Map<String, String> headers = new HashMap<String, String>();
        headers.put(SignEnum.SECRETKEY.toString(), RandUtil.uuid());
        headers.put(SignEnum.SIGNTOKEN.toString(), SignatureUtil.sign(headers.get(SignEnum.SECRETKEY.toString()), methodname));
        return formPost(url, params, headers);
    }

    public static String httpGetWithSign(String url, String methodname) {
        Map<String, String> headers = new HashMap<String, String>();
        headers.put(SignEnum.SECRETKEY.toString(), RandUtil.uuid());
        headers.put(SignEnum.SIGNTOKEN.toString(), SignatureUtil.sign(headers.get(SignEnum.SECRETKEY.toString()), methodname));
        return httpGetWithHeaders(url, headers, null);
    }
    ...
    public static String postJson(String url, Map<String, String> headers, String body, String charset, int connTimeout, int socketTimeout, HttpHost proxy) {
...
//    }
    ...
    public static String httpGetWithHeaders(String url, Map<String, String> headers, HttpHost proxy) {
        CloseableHttpClient httpclient = HttpConnectionManager.getInstance().getHttpClient();
        HttpGet httpGet = new HttpGet(url);
