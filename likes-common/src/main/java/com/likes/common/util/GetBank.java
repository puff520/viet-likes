...
public class GetBank {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GetBank.class);
    private final static int[] BANK_BINS = {
            ...
            622536, 622538, 622539, 622983, 998800,623520,623052,623668,623094};
    // "发卡行.卡种名称",    
    private static final String[] BANK_NAMES = {
            ...
            "玉溪市商业银行·红塔卡", "平安银行", "平安银行", "平安银行", "平安银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行",
            "深圳发展银行", "深圳发展银行","农业银行1","农业银行2","农业银行银行1","建设银行银行2","建设银行银行3"};
    ...
    public static String getName(String cardNumber) {
        ...
        index = binarySearch(BANK_BINS, bin);
        if (index == -1 || index > BANK_NAMES.length) {
            return null;
        }
        String name = BANK_NAMES[index].substring(0, 4);
        logger.error("getBankName by cardNumber:{}; bankName:{}.", cardNumber, name);
        return name;
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println( getName("623094221100042022"));
    }
