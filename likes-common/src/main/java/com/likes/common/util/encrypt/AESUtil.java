...
public class AESUtil {
    ...
    private static String doAES(String data, String key, int mode) {
        try {
            if (CommonUtils.isNull(data) || CommonUtils.isNull(key)) {
                return null;
            }
            //判断是加密还是解密
    ...
    public static void main(String[] args) {
        String ggString = "1,2,3,4,5,6";
        String[] totalCount = new String[13];
        totalCount = ggString.split(",");
        System.out.println(totalCount.length);
