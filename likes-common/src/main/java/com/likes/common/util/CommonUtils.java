...
public class CommonUtils {
    ...
    private static final Pattern namePattern = Pattern.compile("[\u4e00-\u9fa50-9a-zA-Z]+");
    ...
    public static boolean isNumeric(String str) {
        ...
        return str.length() > 0 && isNum.matches();
    }
    ...
    private static final Pattern contentPattern = Pattern
    ...
    public static boolean isContentIll(String content) {
        ...
        return ill.equals(content); // 有特殊字符
    }
    ...
    public static String subPhoneLastFourNumber(String phoneNumber) {
        ...
        try {
            ...
            if (phoneNumber.length() >= 4) {
                // 一个参数表示截取传递的序号之后的部分
                strsub = phoneNumber.substring(phoneNumber.length() - 4);
            } else {
                return strsub;
            }
        } catch (Exception e) {
