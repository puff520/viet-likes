...
import com.likes.common.model.dto.result.BjpksGuanYaHeCountDTO;
import com.likes.common.model.dto.result.BjpksLiangMian;
...
public class BjpksUtils {
     ...
     * @return
     */
    public static List<KjlsVO> historySg(List<BjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }
     ...
     * @return
     */
    public static List<Map<String, Object>> lishiSg(List<BjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }
        int totalIssue = sgs.size();
...
//            }
     ...
     * @return
     */
    public static Map<String, Object> sgDetails(BjpksLotterySg sg) {
        if (sg == null) {
            return null;
        }
     ...
     * @return
     */
    public static Map<String, SscMissNumDTO> queryMissVal(List<BjpksLotterySg> sg, Integer start, Integer end) {
     ...
     * @return
     */
    public static Map<String, BjpksLiangMian> queryLiangMianMissVal(List<BjpksLotterySg> sg) {
        Map<String, BjpksLiangMian> map = new HashMap<>();
        if (sg == null) {
            return map;
        }
        ...
        map.put("0", new BjpksLiangMian(arr[0], arr[1], arr[2], arr[3]));
        for (int j = 1; j < 6; j++) {
            int k = 6 * j - 2;
            map.put("" + j, new BjpksLiangMian(arr[k], arr[k + 1], arr[k + 2], arr[k + 3], arr[k + 4], arr[k + 5]));
        }
        for (int j = 6; j < 11; j++) {
            int k = 4 * j + 10;
            map.put("" + j, new BjpksLiangMian(arr[k], arr[k + 1], arr[k + 2], arr[k + 3]));
        }
        return map;
    }
     ...
     * @return
     */
    public static Integer getBjpksMissingCount(int i, List<BjpksLotterySg> bjpksLotterySg, int num) {
        int number = 0;
        for (int j = i; j < 200 && j < bjpksLotterySg.size(); j++) {
            //开奖号码
            String[] split = bjpksLotterySg.get(j).getNumber().split(",");
     ...
     * @return
     */
    public static Integer getSumOpenCount(List<BjpksLotterySg> bjpksLotterySg, int number) {
        int count = 0;
        for (int i = 0; i < bjpksLotterySg.size(); i++) {
            //开奖号码
            String[] split = bjpksLotterySg.get(i).getNumber().split(",");
     ...
     * @return
     */
    public static Integer getNoOutOpenCount(List<BjpksLotterySg> bjpksLotterySg, int number) {
        int count = 0;
        for (int i = 0; i < bjpksLotterySg.size(); i++) {
            //开奖号码
            String[] split = bjpksLotterySg.get(i).getNumber().split(",");
     ...
     * @return
     */
    public static Map<String, Object> queryTotal(List<BjpksLotterySg> sgList) {
        if (sgList == null) {
            return null;
        }
        ...
        for (BjpksLotterySg list : sgList) {
