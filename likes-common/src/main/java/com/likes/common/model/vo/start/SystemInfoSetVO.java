...
/**
 * @author lzy
 * @create 2018-06-13 16:37
 **/
public class SystemInfoSetVO {
    ...
    private String googleVerifyIsOpen;
    ...
    public String getGoogleVerifyIsOpen() {
        return googleVerifyIsOpen;
    }

    public void setGoogleVerifyIsOpen(String googleVerifyIsOpen) {
        this.googleVerifyIsOpen = googleVerifyIsOpen;
    }
}
