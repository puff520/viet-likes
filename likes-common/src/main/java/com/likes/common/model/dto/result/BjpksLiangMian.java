...
public class BjpksLiangMian {
    ...
    public BjpksLiangMian() {
    }

    public BjpksLiangMian(Integer da, Integer xiao, Integer dan, Integer shuang) {
        this.da = da;
        this.xiao = xiao;
        this.dan = dan;
        this.shuang = shuang;
    ...
    public BjpksLiangMian(Integer da, Integer xiao, Integer dan, Integer shuang, Integer lon, Integer hu) {
        this.da = da;
        this.xiao = xiao;
        this.dan = dan;
        this.shuang = shuang;
