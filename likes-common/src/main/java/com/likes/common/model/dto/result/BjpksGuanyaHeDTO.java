...
public class BjpksGuanyaHeDTO {
    ...
    private Integer twoCountTotal;
    private Integer bigCountTotal;
    private Integer smallCountTotal;
    //总期数
    ...
    public Integer getTwoCountTotal() {
        return twoCountTotal;
    }

    public void setTwoCountTotal(Integer twoCountTotal) {
        this.twoCountTotal = twoCountTotal;
    }

    public Integer getBigCountTotal() {
        return bigCountTotal;
    }

    public void setBigCountTotal(Integer bigCountTotal) {
        this.bigCountTotal = bigCountTotal;
    }

    public Integer getSmallCountTotal() {
        return smallCountTotal;
    }

    public void setSmallCountTotal(Integer smallCountTotal) {
        this.smallCountTotal = smallCountTotal;
    }
