 ...
 */
public class PceggLotterySgDTO3 {
    private Integer number0;//特码号 为0的特码和值
    ...
    private Integer realNum; // 开奖号码

    //总期数
    private Integer countIssue;
    ...
    public PceggLotterySgDTO3() { }

    public PceggLotterySgDTO3(boolean isInit) {
        if (isInit) {
            this.number0 = 0;
            this.number1 = 0;
            this.number2 = 0;
    ...
    public PceggLotterySgDTO3(Integer number0, Integer number1, Integer number2, Integer number3, Integer number4, Integer number5, Integer number6, Integer number7, Integer number8, Integer number9, Integer number10, Integer number11, Integer number12, Integer number13, Integer number14, Integer number15, Integer number16, Integer number17, Integer number19, Integer number18, Integer number20, Integer number21, Integer number22, Integer number23, Integer number24, Integer number25, Integer number26, Integer number27, String issue, Integer realNum, Integer countIssue) {
